...
import de.will_smith_007.tntrun.managers.*;
...
public class TNTRun extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (databaseFileManager.isDatabaseEnabled()) {
            statsSQL = new MySQL(databaseFileManager, LOGGER);
        ...
        final StatsManager statsManager = new StatsManager(databaseFileManager, statsSQL);

        final PlayerAFKScannerScheduler playerAFKScannerScheduler = new PlayerAFKScannerScheduler(this, gameAssets);

        final ProtectionCountdownScheduler protectionCountdownScheduler = new ProtectionCountdownScheduler(this,
                gameAssets, playerAFKScannerScheduler);

        final LobbyCountdownScheduler lobbyCountdownScheduler = new LobbyCountdownScheduler(this,
                gameAssets, mapManager, protectionCountdownScheduler);
